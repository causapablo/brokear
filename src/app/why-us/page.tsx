  ...
  return (
    <main className="">
      <section className="">
        ...
        <div id="background">
          <div id="container" className="container mx-auto max-w-[1300px] pt-5">
          ...
          <div id="container" className="container mx-auto max-w-[1300px] py-28">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <div id="col2" className=" flex flex-wrap items-end">
                ...
                >
                  <Image
                    className="absolute -top-[90px] lg:-top-[120px] left-[55px] lg:left-[200px] hover:animate-wiggle"
                    src={SideBarLogo}
                    alt="SidebarblogLogo"
                  />
                  <div className="space-y-4 flex flex-col pb-5">
                    ...
                    <p className="w-fit mx-4 text-center text-[19px] pt-52 lg:pt-0">

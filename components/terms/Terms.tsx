      ...
      <div className='space-y-8'>
        ...
        <div>
          ...
          <div className='space-y-6'>
            ...
            <ul className='list-disc pl-7 text-[18px] leading-relaxed space-y-2 px-2 lg:px-0'>
              ...
              <li className="marker:text-red">Attempt to decompile or reverse engineer any software contained on Brokear’s web site.</li>
        ...
        <div>
          <h2 className='font-Fitgree text-[26px] font-semibold px-2 lg:px-0'>3. Disclaimer</h2>
          <p className='text-[18px] leading-relaxed px-2 lg:px-0'>
        ...
        <div>
          <h2 className='font-Fitgree text-[26px] font-semibold px-2 lg:px-0'>4. Limitations</h2>
          <p className='text-[18px] leading-relaxed px-2 lg:px-0'>
        ...
        <div>
          <h2 className='font-Fitgree text-[26px] font-semibold px-2 lg:px-0'>5. Revisions and Errata</h2>
          <p className='text-[18px] leading-relaxed px-2 lg:px-0'>
        ...
        <div>
          <h2 className='font-Fitgree text-[26px] font-semibold px-2 lg:px-0'>6. Links</h2>
          <p className='text-[18px] leading-relaxed px-2 lg:px-0'>
        ...
        <div>
          <h2 className='font-Fitgree text-[26px] font-semibold px-2 lg:px-0'>7. Site Terms of Use Modifications</h2>
          <p className='text-[18px] leading-relaxed px-2 lg:px-0'>
        ...
        <div>
          <h2 className='font-Fitgree text-[26px] font-semibold px-2 lg:px-0'>8. Governing Law</h2>
          <p className='text-[18px] leading-relaxed px-2 lg:px-0'>

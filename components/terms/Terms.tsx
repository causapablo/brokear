...
function Terms() {
  return (
    <div className=''>
      <h1 className='font-Fitgree text-[38px] font-semibold text-white'>Terms & Conditions</h1>
      <div className='space-y-8'>
        <div>
          <h2 className='font-Fitgree text-[26px] font-semibold text-white'>1. Terms</h2>
        ...
        <div>
          <h2 className='font-Fitgree text-[26px] font-semibold text-white'>2. Use License</h2>
          <div className='space-y-6'>
            ...
            <ul className='list-disc pl-7 text-[18px] leading-relaxed space-y-2'>
              <li className="marker:text-red text-white">modify or copy the materials.</li>
              <li className="marker:text-red text-white">use the materials for any commercial purpose, or for any public display (commercial or non-commercial).</li>
              <li className="marker:text-red text-white">attempt to decompile or reverse engineer any software contained on Brokear’s web site.</li>
              <li className="marker:text-red text-white">remove any copyright or other proprietary notations from the materials.</li>
              <li className="marker:text-red text-white">transfer the materials to another person or “mirror” the materials on any other server.</li>
            </ul>
            <p className='text-[18px] leading-relaxed text-white'>
        ...
        <div>
          ...
          <p className='text-[18px] leading-relaxed'>
            ...
            of intellectual property or other violation of rights. Further, Brokear does not warrant or make
        ...
        <div>
          ...
          <p className='text-[18px] leading-relaxed'>
            ...
            the materials on Brokear’ Internet site, even if Brokear or a Brokear authorized
        ...
        <div>
          ...
          <p className='text-[18px] leading-relaxed'>
            ...
            Brokear may make changes to the materials contained on its web site at any time without notice. Ingredient
